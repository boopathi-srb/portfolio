...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start">
      <div className="relative flex h-[50vh] lg:h-full w-full max-h-screen place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial
       ...
       after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10
        ...
        <p className="absolute top-1/2 left-1/2 -translate-y-40 -translate-x-1/2 w-full dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:text-white text-2xl lg:text-6xl text-center font-semibold">Rathina Boopathi Sundarraj</p>
        <Image 
